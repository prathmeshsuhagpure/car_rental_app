        ...
        Container(
          ...
          child: Row(
            ...
            children: [
              ...
              Text(
                (widget.booking.status.toUpperCase()), // Fixed null safety
                style: TextStyle(
                  color: _statusColor,
  ...
  Widget _buildActionButtons(BuildContext context) {
    return Row(
      children: [
        ...
        Expanded(
          child: _buildModernButton(
            onPressed: widget.booking.status.toLowerCase() == 'cancelled'
                ? null
                : () async {
            ...
            label: widget.booking.status.toLowerCase() == 'cancelled'
                ? 'Cancelled'
                : 'Cancel',
            icon: widget.booking.status.toLowerCase() == 'cancelled'
                ? Icons.block
                : Icons.cancel_outlined,
            isPrimary: false,
            isDestructive: widget.booking.status.toLowerCase() != 'cancelled',
          ),
        ),
      ],
    );
